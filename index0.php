		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<p><b> Why BookMyBusTicket for Bus Booking? </b>
...
<br> <br>
<p><b>Booking Bus Ticket with BookMyBusTicket</b> <br>
					...
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="https://www.facebook.com/purnendu.dutta.9275">Purnendu Dutta</a> </li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									...
									<a href="https://www.facebook.com/purnendu.dutta.9275">Purnendu Dutta</a> 521126
								</li>
								<li>
									<h3>Mail</h3>
					...
					<ul class="copyright">
						<li>&copy; 2024 BookMyBusTicket. All rights reserved. Brought To You By <a href="https://www.facebook.com/purnendu.dutta.9275">Purnendu Dutta</a></li>
